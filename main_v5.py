...
def to_graphviz(graph):
    """Преобразует граф зависимостей в формат Graphviz (DOT)"""
...
def main():
    ...
    print(to_graphviz(full_test_graph))  # вместо ASCII-дерева
    ...
    print(to_graphviz(full_real_graph))  # вместо ASCII-дерева
